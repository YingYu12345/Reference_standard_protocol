...
# refDEG.R
# example:
# Rscript path-to/refDEG.R -d path-to/DEG_limma_2024-04-02.csv -r ref_expr_2024-04-02.csv -o path-to/
...
print_usage <- function() {
  cat("Actual Usage: Rscript refDEG.R [options]\n\n")
  cat("Example:\n")
  cat("  Rscript path-to/refDEG.R -d path-to/DEG_limma_2024-04-02.csv -r ref_expr_2024-04-02.csv -o path-to/\n")
